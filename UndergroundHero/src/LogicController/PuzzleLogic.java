...
//			floor1Music();
			...
			if(puzzle.getId() == 3)
			{
				System.out.println("As the door open, you notice the hallway is too long. "
						       ...
						       + "\nthe cloth is no more. You took a step back and thought "
						      + "\n\"I need to look for another way. Unless, if I can move fast "
						       + "\nenough I can probably avoid guns and lasers.\" ");
			}
