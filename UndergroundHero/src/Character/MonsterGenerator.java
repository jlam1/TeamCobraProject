...
public class MonsterGenerator {
	...
	private void generateMonsterList(){
		...
		Monster mon00 = new Monster(0, "Puzzler", 				5, 5, 5, 2, 1, true, null,						"A man with a purple suit and question marks "
		...
		Monster mon01 = new Monster(1, "Pogo",					10, 10, 5, 2, 3, true, null,					"A man on a pogo stick. The pogo stick "
		...
		Monster mon02 = new Monster(2, "Giant Bull Shark",		13, 13, 6, 3, 3, true, itemList.get(7),			"A giant bull shark that lives in the lake in the "
		...
		Monster mon03 = new Monster(3, "Giant Robotic Sentry",	15, 15, 6, 4, 1, true, itemList.get(9),			"A giant robotic sentry guarding an entrance."
			...
			mon03.addSkill(new Skill(0, "IMPALE", "NORMAL", 1.5, 20.0, "Impales with blades in his hand. It's super effective."));
			mon03.addSkill(new Skill(1, "LASER SHOT", "NORMAL", 1.0, 80.0, "Fires a laser shot from his chest."));
			monsterList.add(mon03);
		
		Monster mon04 = new Monster(4, "Quinn Har",				20, 20, 7, 5, 3, true, null,					"A female clown with a red and black color scheme. "
		...
		Monster mon05 = new Monster(5, "Joe Ker",				25, 25, 8, 6, 2, true, null,					"A Deranged clown with a thirst for "
		...
		Monster mon06 = new Monster(6, "Hula Hooper",			6, 6, 2, 0, 1, false, null,						"A man using a hula hoop. There are knives "
		...
		Monster mon07 = new Monster(7, "Wild Hyena",			8, 8, 4, 0, 3, false, null,   				"A starving wild hyena that lives in the dark "
