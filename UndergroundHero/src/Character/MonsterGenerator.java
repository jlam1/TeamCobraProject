...
public class MonsterGenerator {
	...
	private void generateMonsterList(){
		...
		//int hp, int atk, int spd, int def
		
		ArrayList<Item> itemList = new ItemGenerator().getItemList();
		monsterList = new ArrayList<Monster>();
		
		Monster mon00 = new Monster(0, "PUZZLER", 				8, 8, 5, 2, 1, true, null,						"A man with a purple suit and question marks "
		...
		Monster mon01 = new Monster(1, "POGO",					10, 10, 6, 2, 3, true, null,					"A man on a pogo stick. The pogo stick "
		...
		Monster mon02 = new Monster(2, "GIANT BULL SHARK",		13, 13, 7, 1, 3, true, itemList.get(7),			"A giant bull shark that lives in the lake in the "
		...
		Monster mon03 = new Monster(3, "GIANT ROBOT SENTRY",	14, 14, 6, 2, 1, true, itemList.get(9),			"A giant robotic sentry guarding an entrance."
		...
		Monster mon04 = new Monster(4, "QUINN HAR",				7, 7, 8, 3, 2, true, null,					"A female clown with a red and black color scheme. "
		...
		Monster mon05 = new Monster(5, "JOE KER",				11, 11, 9, 3, 2, true, null,					"A Deranged clown with a thirst for "
		...
		Monster mon07 = new Monster(7, "WILD HYENA",			6, 6, 5, 0, 3, false, null,   				"A starving wild hyena that lives in the dark "
