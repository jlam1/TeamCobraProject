...
public class MonsterGenerator {
	...
	private void generateMonsterList(){
		...
		Monster mon02 = new Monster(2, "Giant Bull Shark",		12, 7, 0, 3, true, itemList.get(7),	"What every good super villain needs; a giant bull shark that lives in the lake that their underground lair obviously has. His name is Snappy.");
		monsterList.add(mon02);
		
		Monster mon03 = new Monster(3, "Giant Robotic Sentry",	15, 4, 5, 1, true, itemList.get(9),	"A giant robotic sentry guarding the entrance to the final floor. The sentry is a slow moving bipedal robot with lots of armor plating (looks something like a cross between Ultron and the Destroyer from Thor, but talle  r and with a thinner torso). The sentry is armed with a gatling laser, sonic emitters, and a blade that is stored in his forearm when not in use.");
