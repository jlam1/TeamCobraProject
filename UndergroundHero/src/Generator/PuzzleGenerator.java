...
public class PuzzleGenerator {
	...
	private void generatePuzzleList() {
		...
		puzzle = new PuzzleKey			(3, "The Laser Hallway", 1, null, key("Speed Boots"), "A laser blocks your path, it seems like I'll need to be really quick on my feet to dodge them.");
		puzzleList.add(puzzle);
		
		puzzle = new PuzzleRiddle		(4, "The Colored Buttons", 0, null,  "213", "In room 2-7 is a monitor with several groups of numbers, each group a different color. The final group of numbers is “2, 1, 3” in black. In room 2-8 are three buttons, red, green, and blue.");
		puzzleList.add(puzzle);
		
		puzzle = new PuzzleKey			(5, "Jump The Chasm", 1, null,  key("Grappling Hook"), "There appears to be a strange outcropping of rock in the ceiling. If only you could attach some rope to it you could swing across.");
		puzzleList.add(puzzle);
