...
public class PuzzleGenerator {
	...
	private void generatePuzzleList() {
		...
		puzzle = new PuzzleKey			(3, "The Laser Hallway", 1, ic.keyItem("Speed Boots"), "There is a hallway that shoots lasers at anyone who tries to pass in room 2-5. If the player tries to pass without the Speed Boots, then they are unable to and take 1 HP of damage.");
		puzzleList.add(puzzle);
