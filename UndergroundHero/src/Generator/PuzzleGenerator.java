...
public class PuzzleGenerator {
	...
	private void generatePuzzleList() {
		...
		puzzle = new PuzzleKey			(3, "The Laser Hallway", 1, key("Speed Boots"), "A laser blocks your path, it seems like I'll need to be really quick on my feet to dodge them.");
		puzzleList.add(puzzle);
		...
		puzzle = new PuzzleKey			(5, "Jump The Chasm", 1, key("Grappling Hook"), "There appears to be a strange outcropping of rock in the ceiling. If only you could attach some rope to it you could swing across.");
		puzzleList.add(puzzle);
		
		puzzle = new PuzzleKey			(6, "Security Bypass", 1, key("Computer Chip"), "A computer terminal stands in your way, it looks like I need to insert some kind of [COMPUTER CHIP] for it activate.");
		puzzleList.add(puzzle);
